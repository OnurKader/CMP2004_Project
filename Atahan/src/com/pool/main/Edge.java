...
public class Edge
{
	...
	public void collide(Ball ball) {
		if(orientation == 0)
		{
			...
			{
				// Top
				if(ball.pos.x() + ball.radius + 2 >= pos_1.x() && ball.pos.x() - ball.radius - 2 <= pos_2.x() && ball.pos.y() - ball.radius - 2 <= pos_1.y()) {
		...
		else
		{
			...
			{
				// Left
				if(ball.pos.y() + ball.radius + 2 >= pos_1.y() && ball.pos.y() - ball.radius - 2 <= pos_2.y() && ball.pos.x() - ball.radius - 2 <= pos_1.x()) {
